    ...
    <div className="mb-2900">
      ...
      <div className="flex items-center gap-400">
        <button
          ...
          className="flex items-center justify-center rounded-full bg-primary-blue px-1600 py-400 text-detail-2-medium text-neutral-white"
        >
        ...
        <button
          ...
          className="flex items-center justify-center bg-transparent border-solid rounded-full border-[1px] border-primary-blue px-1600 py-400 text-detail-2-medium text-primary-blue"
        >
