...
function EventIntroMain() {
  ...
  return (
    <div className="bg-gradient-violetblue-cobaltblue w-screen h-screen pt-[150px] flex justify-between">
      <div className="pl-3000">
        <div className="flex w-[73%] h-[8%] items-center justify-center bg-primary-berrypurple text-detail-1-bold text-neutral-white mb-600">
          진짜 캐스퍼 EV를 얻을 수 있는 기회
        </div>
        <div className="text-heading-banner-title text-neutral-black mb-1000">
          캐스퍼 EV와
          <br />
          함께 떠나기
        </div>
        ...
        <div className="flex mt-600 gap-300">
          <button
            ...
            className="flex items-center justify-center rounded-full px-800 py-400 bg-neutral-white text-neutral-black text-detail-3-semibold"
          >
            이벤트 참여하기
          </button>
          <button
            onClick={handleMovenewCarIntro}
            className="flex items-center justify-center bg-transparent rounded-full px-800 py-400 text-neutral-black text-detail-3-semibold border-[2px] border-solid border-neutral-black"
          >
            캐스퍼 EV 알아보기
